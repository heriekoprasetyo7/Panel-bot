...
module.exports = {
    ...
    PRODUCTS: [
        ...
        { id: 'p4k', name: 'RAM 4GB', price: 4000, emoji: '🥇', cpu: 250, ram: 4096, disk: 20480 },
        { id: 'p5k', name: 'RAM 5GB', price: 5000, emoji: '💎', cpu: 300, ram: 5120, disk: 25600 },
        { id: 'p6k', name: 'RAM 6GB', price: 6000, emoji: '⚡', cpu: 350, ram: 6144, disk: 30720 },
    ...
    SURAH_LIST: [
        ...
        { number: 55, name: 'Ar-Rahman', ayat: 78, arab: 'الرحمن' },
        { number: 67, name: 'Al-Mulk', ayat: 30, arab: 'الملك' },
        { number: 112, name: 'Al-Ikhlas', ayat: 4, arab: 'الإخلاص' },
        { number: 113, name: 'Al-Falaq', ayat: 5, arab: 'الفلق' },
